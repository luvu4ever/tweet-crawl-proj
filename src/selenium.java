...
public class selenium {
    ...
    public static List<Integer> Replys = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        run(keyword, "2021-08-01", "2021-09-01");
    }
...
//            System.out.println(UserTags.get(i) + "," + TimeStamps.get(i) + "," + "," + reTweets.get(i) + "," + Likes.get(i));
//        }
...
//        get account href
        WebElement account = article.findElement(By.xpath(ACCOUNT_LINK));
        Accounts.add(account.getText().replaceAll("\n", " "));
//        get tweet
        //remove /n from tweet
        WebElement tweet = article.findElement(By.xpath(".//div[@data-testid='tweetText']"));
...
//        get time
        ...
        //        get reply
        WebElement reply = article.findElement(By.xpath(REPLY_XPATH));
        if (reply.getText().replaceAll("\n", "").equals("")) {
            Replys.add(0);
        } else {
            Replys.add(Integer.parseInt(reply.getText().replaceAll("\n", "")));
        }
